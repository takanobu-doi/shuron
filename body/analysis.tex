...
%    gas & 検出効率 (\%)\\
%    \midrule
%    $\mathrm{CH}_{4}$ & $55$ \\% \pm 7.42$ \\
%    $\mathrm{CH}_{4}\ (3) + \mathrm{H}_{2}\ (7)$ & $91$ \\% \pm 9.54$ \\
%    $\mathrm{CH}_{4}\ (4) + \mathrm{He}\ (6)$ & $78$ \\% \pm 8.83$ \\
%    iso-$\mathrm{C}_{4}\mathrm{H}_{10}\ (1) + \mathrm{H}_{2}\ (9)$ & $87$ \\% \pm 9.33$ \\
%    iso-$\mathrm{C}_{4}\mathrm{H}_{10}\ (1) + \mathrm{He}\ (9)$ & $90$ \\% \pm 9.49$ \\
%    \bottomrule
%  \end{tabular}
%\end{table}
...
%    \midrule
%    $\mathrm{CH}_{4}$ & 11.0 & 33.0  \\
%    $\mathrm{CH}_{4}\ (3) + \mathrm{H}_{2}\ (7)$ & 1.25 & 20.0 \\
%    $\mathrm{CH}_{4}\ (4) + \mathrm{He}\ (6)$ & 9.30 & 23.7 \\
%    iso-$\mathrm{C}_{4}\mathrm{H}_{10}\ (1) + \mathrm{H}_{2}\ (9)$ & 4.56 & 23.6 \\
%    iso-$\mathrm{C}_{4}\mathrm{H}_{10}\ (1) + \mathrm{He}\ (9)$ & 5.00 & 22.3 \\
%    \bottomrule
%  \end{tabular}
%\end{table}
...
%    \midrule
%    $\mathrm{CH}_{4}$ & 46.4 & 77.9 \\
%    $\mathrm{CH}_{4}\ (3) + \mathrm{H}_{2}\ (7)$ & 2.10 & 24.6 \\
%    $\mathrm{CH}_{4}\ (4) + \mathrm{He}\ (6)$ & 3.34 & 28.2 \\
%    iso-$\mathrm{C}_{4}\mathrm{H}_{10}\ (1) + \mathrm{H}_{2}\ (9)$ & -1.27 & 29.8 \\
%    iso-$\mathrm{C}_{4}\mathrm{H}_{10}\ (1) + \mathrm{He}\ (9) $ & 3.05 & 31.4 \\
%    \midrule
%  \end{tabular}
%\end{table}
角度分解能は，他と比較して$\mathrm{CH}_{4}$単体の場合に大きいことが分かる．
...
%    \midrule
%    $\mathrm{CH}_{4}$ & 7.63 & $4.91\times 10^{-2}$ \\
%    $\mathrm{CH}_{4}\ (3) + \mathrm{H}_{2}\ (7)$ & 7.67 & $1.66\times 10^{-2}$ \\
%    $\mathrm{CH}_{4}\ (4) + \mathrm{He}\ (6)$ & 7.67 & $2.05\times 10^{-2}$ \\
%    iso-$\mathrm{C}_{4}\mathrm{H}_{10}\ (1) + \mathrm{H}_{2}\ (9)$ & 7.67 & $1.75\times 10^{-2}$ \\
%    iso-$\mathrm{C}_{4}\mathrm{H}_{10}\ (1) + \mathrm{He}\ (9)$ & 7.67 & $1.90\times 10^{-2}$ \\
%    \bottomrule
%  \end{tabular}
%\end{table}
