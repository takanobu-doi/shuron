...
本研究ではMAIKo TPC から得られたトラック情報の抽出を人間の目 (eye-scan) で行った．
...
極角分解能は，\Methane 単体の場合に大きいことが分かる．
\begin{figure}
  \centering
  \begin{minipage}{0.45\columnwidth}
    \centering
...
\begin{figure}
  ...
  \begin{minipage}{0.45\columnwidth}
    \centering
    \includegraphics[clip, width=\columnwidth]{dphi_10020_fit.eps}
...
\begin{figure}
  ...
  \begin{minipage}{0.45\columnwidth}
    \centering
    \includegraphics[clip, width=\columnwidth]{dphi_10022_fit.eps}
    \caption{\MethaneHydro を用いた場合の方位角の差分．}
    \label{fig::dphi_ch4_h2}
  \end{minipage}
  \begin{minipage}{0.45\columnwidth}
    \centering
    \includegraphics[clip, width=\columnwidth]{dphi_10021_fit.eps}
...
\begin{figure}
  ...
  \begin{minipage}{0.45\columnwidth}
    \centering
    \includegraphics[clip, width=\columnwidth]{dphi_10024_fit.eps}
    \caption{\isoButaneHydro を用いた場合の方位角の差分．}
    \label{fig::dphi_ic4h10_h2}
  \end{minipage}
  \begin{minipage}{0.45\columnwidth}
    \centering
    \includegraphics[clip, width=\columnwidth]{dphi_10023_fit.eps}
...
${}^{12}\mathrm{C}$の励起エネルギーは\SI{7.65}{\mega\electronvolt} となる．
