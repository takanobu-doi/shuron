...
$x, z$座標は$\mu$-PIC のstrip 数に\SIU{400}{\micro\metre}をかけることで決定できる．
...
%  \end{tabular}
%\end{table}
\Methane 単体と\MethaneHerium 以外は約\SIU{90}{\percent}の検出効率となっている．
...
${}^{12}\mathrm{C}$の励起エネルギーは\SIU{7.65}{\mega\electronvolt} となっている．
eye-scanで決定した不変質量から基底状態の${}^{12}\mathrm{C}$の質量を引くことで励起エネルギーを求め，
\SIU{7.65}{\mega\electronvolt} を再構築できるか評価する．
...
よって，検出ガスには\isoButaneHydro (\SIU{100}{\hecto\pascal}) を用いる．
