...
ディフュージョン係数が大きくトラックが太くなると予測されることと，
...
\begin{table}
  ...
  \caption[検出ガスのW値とエネルギー損失と$N_{\rm e}$．]
          ...
          ガス中を\SI{12.8}{\milli\metre} 進んだ時のものである．}
...
$\alpha$線源から放出される$\alpha$粒子のエネルギーは平均\SI{4.2}{\mega\electronvolt}であるが，
実際に測定する$\alpha$粒子のエネルギーは数百\si{\kilo\electronvolt}である．
そこで，$\alpha$線源の前に\SI{15}{\micro\metre}のカプトンを通過させて有感領域に入射することで
低エネルギー$\alpha$粒子の測定を行った．
