...
\Methane は実測とMagboltz による計算値に不一致が見られるが，検出ガスに含まれる水分の影響が疑われる．
\Methane のみ\SI{50}{\hecto\pascal} とその他のガスと比較して圧力が半分であるため，不純物の影響が大きく出ていると考えられる．
不純物のドリフト速度への影響は付録\ref{app::drift_speed_humid_dep}で述べる．
\begin{table}
  \centering
...
今回の測定では\ang{0}方向の$\alpha$線を用いて測定した．
