...
図\ref{fig::drift_v_image}の右のようにドリフト方向に$\Delta y$~\si{\milli\metre}，
...
増幅率は荷電粒子が検出ガス中を通過した際に発生する電子数 ($N_{\mathrm{e}}$) と
...
測定に用いた$\alpha$線源はactivity を大きくするために，多くの${}^{241}\mathrm{Am}$が線源に含まれている．
