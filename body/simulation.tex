...
\begin{figure}
  \centering
  \includegraphics[clip, width=0.8\columnwidth]{track_width_2.eps}
...
\begin{figure}
  ...
  \begin{subfigure}{0.8\columnwidth}
    \centering
    \includegraphics[clip, width=\columnwidth]{diffusion_width_l.eps}
    \caption{ドリフト方向に対して平行な方向．}
    \label{fig::diffusion_compare_l}
  \end{subfigure}
  \begin{subfigure}{0.8\columnwidth}
    \centering
    \includegraphics[clip, width=\columnwidth]{diffusion_width_t.eps}
