...
ドリフトケージはplate，wire，grid，GEM (gas electron multiplier)，$\mu$-PIC~\cite{mupic}からなる．
...
荷電粒子によって同じ場所に生成された電子が読み出し面に到達するまでに広がるため，
トラックが太く検出される．
...
\end{align}
となる．
計算コードMagboltz によって得られた拡散係数 ($D_{\mathrm{Magboltz}}$) を表\ref{tab::diffusion}に示す．
