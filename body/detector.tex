...
また，anode strip，cathode strip ともに32~chごとにまとめて信号波形を\SI{25}{\mega\hertz}でFADC で取得している．
...
そこで，検出する対象である$\alpha$粒子の $dE/dx$ が適切な大きさとなるガスの種類と圧力の候補を選出する．
