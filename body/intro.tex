...
A = 5と8の原子核が生成してもすぐに軽い核2つに分裂してしまう．
...
脱励起と逆反応である${}^{12}\mathrm{C}(\mathrm{n},\mathrm{n}'){}^{12}\mathrm{C}(0_2^+)$の体積当たりの反応率は
\begin{equation}
...
\end{equation}
と表される．
$E$はc.m.系での中性子のエネルギー，$\rho_{\mathrm{n}}$は中性子の質量密度 (\si{\gram\per\cubic\centi\metre})，
...
特に，$0_2^+$状態へ励起させることができる中性子エネルギーの閾値付近
($E_{\mathrm{n}}=\SI{8.35}{\mega\electronvolt}$) における断面積が重要となる．
...
約\SIrange{8}{17}{\mega\electronvolt}の領域におけるg.s. $\rightarrow$ Hoyle状態のデータがない．
...
この中性子を大実験室側へ取り出すための半径約\SI{55}{\milli\metre}の取り出し穴が図\ref{pic::hole}のように重照射室と
大実験室を隔てる壁に開いている．
図\ref{pic::hole}は重照射室と大実験室を隔てる壁を大実験室から撮影した写真である．
この取り出し穴から中性子を取り出すことで半径が約\SI{55}{\milli\metre}にコリメートされた
...
\section{本研究の目的}
${}^{12}\mathrm{C}(\mathrm{n},\mathrm{n}'){}^{12}\mathrm{C} (0_2^+)$反応の断面積測定のためには，
