...
\begin{figure}
  \centering
  \includegraphics[clip, width=0.7\columnwidth]{alpha_e_dist_sim.eps}
  ...
  \includegraphics[clip, width=0.7\columnwidth]{alpha_theta_dist.eps}
...
%このような$\alpha$粒子を効率よく検出することができる検出ガスの種類、圧力等の条件を検討する。
%また、安定したMAIKo TPC のオペレートの条件を検討する。
