...
初期の宇宙では陽子と中性子が融合して原子核が大きくなっていくが，
A = 5と8の原子核が生成してもすぐにA = 4 以下の軽い原子核に分裂してしまうのである．
...
図\ref{fig::triple_alpha}のように2つの$\alpha$から2$\alpha$クラスター状態である${}^{8}\mathrm{Be}$が合成され，
