...
このような恒星が重力により収縮し中心温度が\SIU{e7}{\kelvin}を超えると，
...
${\rm He}$コアが重力により圧縮され温度がおよそ\SIU{e8}{\kelvin}に達するとヘリウム燃焼が始まる．
...
$Q$は\SIU{-7.65}{\mega\electronvolt} (g.s.の場合) または
\SIU{-3.21}{\mega\electronvolt} ($2_{1}^{+}$の場合) となる．
...
$\sigma_{\rm nn'}(E')$は断面積 (\siu{\milli\barn})，$T_{9}$は温度 (\SIU{e9}{\kelvin}) である．
...
原始中性子星の表面温度は\SIU{e10}{\kelvin}に達する．
跳ね返った物質が膨張することで温度が下がっていき，
\SIU{7e9}{\kelvin}ほどになると2つの陽子と2つの中性子が融合し$\alpha$粒子が生成される．
...
$k_{B}T\sim\SIU{100}{\kilo\electronvolt}$である．% 1K = 8.61734e-5 eV
このような中性子がHoyle状態 (Ex = \SIU{7.65}{\mega\electronvolt}) の${}^{12}{\rm C}$と散乱すると，
...
\SIU{14}{\mega\electronvolt}は式 (\ref{eq::dt}) に示すDT 反応で単色で生成可能なエネルギーである．
\begin{equation}
...
核融合炉の中で生成される\SIU{14}{\mega\electronvolt}の中性子は構造材の原子核と反応し損傷させるため，
構造材の中に多く含まれる炭素との反応が詳しく調べられている．
そのため，既知の\SIU{14}{\mega\electronvolt}の中性子と${}^{12}{\rm C}$との断面積のデータと，
本研究での測定結果を比較することが可能となる．
単色エネルギーの中性子を生成可能であること，他データと測定結果の比較が可能であることの2点より，
測定方法の検証として\SIU{14}{\mega\electronvolt}の中性子で断面積の測定を行う．

$E_{\rm n}=\SIU{14}{\mega\electronvolt}$での${}^{12}{\rm C}({\rm n},{\rm n}'){}^{12}{\rm C}^{*}$の散乱断面積は
Ref.~\cite{takahashietal,kondoetal}によりすでに測定されている．
${}^{12}{\rm C}({\rm n},{\rm n}'+3\alpha)$反応の全断面積は\SIU{209}{\milli\barn}，
...
\end{figure}
大阪大学工学研究科のOKTAVIAN~\cite{oktavian} ではDT 反応により\SIU{14}{\mega\electronvolt}の中性子を発生させることができる．
...
この中性子を大実験室側へ取り出すための直径約\SIU{100}{\milli\metre}の取り出し穴が重照射室と
大実験室を隔てる壁に開いている．
この取り出し穴から中性子を取り出すことで直径が約\SIU{100}{\milli\metre}にコリメートされた
...
\SIU{0}{}--\SIU{0.6}{\mega\electronvolt}である．
このような低エネルギーの$\alpha$粒子を効率よく検出するためには，
標的中で$\alpha$粒子が停止しないようにしなければならない．
例えば，\SIU{500}{\kilo\electronvolt}の$\alpha$粒子ではおよそ\SIU{350}{\micro\gram\per\square\centi\metre}の
炭素箔標的で停止してしまう．
