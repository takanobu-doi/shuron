...
\chapter{iso-C$_{\text 4}$H$_{\text{10}}$ + H$_{\text 2}$ (1:9) の検出ガス特性}
...
%  \scalebox{0.7}{\input{gain_grid_V_dep.tex}}
  \includegraphics[clip, width=0.8\columnwidth]{gain_grid_V_dep.pdf} 
...
%  \scalebox{0.7}{\input{gain_GEM_V_dep.tex}}
  \includegraphics[clip, width=0.8\columnwidth]{gain_GEM_V_dep.pdf}
...
%  \scalebox{0.7}{\input{gain_GEM_uPIC_V_dep.tex}}
  \includegraphics[clip, width=0.8\columnwidth]{gain_GEM_uPIC_V_dep.pdf}
...
%  \scalebox{0.7}{\input{gain_uPIC_V_dep.tex}}
  \includegraphics[clip, width=0.8\columnwidth]{gain_uPIC_V_dep.pdf}
  \caption{電子増幅率の$V_{\mu\text{-PIC}}$依存性．実線は1次関数でのフィット結果を示す．}
...
$y_{\text{clk}}$を\si{\milli\metre}単位 ($y_{\text{length}}$) へ変換するには式\eqref{eq::unit_convert}のように，
