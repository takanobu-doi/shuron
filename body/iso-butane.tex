...
Magboltz でドリフトスピードが\SI{0.014}{\milli\metre/\nano\second}となるドリフト電場は\SI{6.80}{\volt/\milli\metre}である．
ドリフト領域の長さは\SI{140}{\milli\metre}であるので，plateとgridの電位差は\SI{952}{\volt}となる．
調整の行いやすさを考え\SI{955}{\volt}を中心に\SI{100}{\volt}間隔で
\SI{455}{}--\SI{1455}{\volt}の範囲で変化させて計10点測定した．
...
$\Delta V_{\text{grid-GEM}} = $\SI{700}{\volt}のとき，\SI{140}{\volt/\milli\metre}であり，
ドリフト電場の約20倍となっている．
...
$\Delta V_{\text{GEM}}$を\SI{10}{\volt}間隔で\SI{300}{}--\SI{390}{\volt}の範囲で変化させて計10点測定した．
...
$\Delta V_{\text{GEM-}\mu\text{-PIC}}$を\SI{50}{\volt}間隔で\SI{550}{}--\SI{750}{\volt}の範囲で変化させて計10点測定した．
...
$V_{\mu\text{-PIC}}$を\SI{10}{\volt}間隔で\SI{350}{}--\SI{440}{\volt}の範囲で変化させて計10点測定した．
...
図\ref{fig::diff_x}の$L$は線源コリメータの$0^{\circ}$穴とgridとのドリフト方向の距離である．
\begin{figure}
  \centering
